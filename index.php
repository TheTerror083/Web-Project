               ...
               <article>
                   <section id="login">
					<form action="" method="post">
                   		<p><label>Email:</label><input type="text" name="userName" value="Admin" placeholder="Your Email"></p>
                   		<p><label>Password:	</label><input type="password" value="Admin" name="password" placeholder="**********"></p>
                   		<br>
